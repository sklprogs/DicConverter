...
class Elems:
    ...
    def __init__ (self,blocks,iabbr,langs=[]
        ...
        f = '[MTExtractor] elems.Elems.__init__'
        self.dicurls = {}
        self.defins  = []
        self.abbr    = iabbr
        self.Debug   = Debug
    ...
    def _get_pair(self,text):
        f = '[MTExtractor] elems.Elems._get_pair'
    ...
    def set_dic_titles(self):
        f = '[MTExtractor] elems.Elems.set_dic_titles'
        if self.abbr:
