...
class Tags:
    ...
    def set_types(self):
        f = '[DicConverter] plugins.multitran.tags.Tags.set_types'
        if self.Success:
    ...
    def debug_blocks(self):
        f = '[DicConverter] plugins.multitran.tags.Tags.debug_blocks'
        mes = _('Debug table:')
    ...
    def debug_tags(self):
        f = '[DicConverter] plugins.multitran.tags.Tags.debug_tags'
        message = ''
        for i in range(len(self.tags)):
    ...
    def set_seps(self):
        f = '[DicConverter] plugins.multitran.tags.Tags.set_seps'
        if self.Success:
    ...
    def split(self):
        f = '[DicConverter] plugins.multitran.tags.Tags.split'
        if self.Success:
            tmp = b''
    ...
    def set_langs(self):
        f = '[DicConverter] plugins.multitran.tags.Tags.set_langs'
        if self.Success:
    ...
    def check(self):
        f = '[DicConverter] plugins.multitran.tags.Tags.check'
