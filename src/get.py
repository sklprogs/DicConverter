...
class Binary:
    ...
    def get_parts2(self,pattern,start=0,end=0):
        ...
        f = '[MTExtractor] get.Binary.get_parts2'
        chunks = []
        if DEBUG:
            mchunks = []
            mpos1   = []
    ...
    def get_parts1(self,pattern,start=0,end=0):
        # Get suggestions
        f = '[MTExtractor] get.Binary.get_parts1'
        chunks = []
        if DEBUG:
            mchunks = []
            mpos1   = []
    ...
    def find_all(self,pattern,start=0,end=0):
        f = '[MTExtractor] get.Binary.find_all'
        matches = []
        if self.Success:
            while True:
    ...
    def get_page_limit(self):
        f = '[MTExtractor] get.Binary.get_page_limit'
        self.get_file_size()
        self.get_block_size()
        if self.Success:
    ...
    def get_file_size(self):
        ''' This should be equal to 'sh.File(self.vfile).get_size()'.
            #NOTE: size = max_pos + 1
        '''
        f = '[MTExtractor] get.Binary.get_file_size'
        if self.Success:
            if not self.fsize:
    ...
    def get_page_limits(self,page_no):
        ...
        f = '[MTExtractor] get.Binary.get_page_limits'
        if self.Success:
    ...
    def get_block_size(self):
        f = '[MTExtractor] get.Binary.get_block_size'
        if self.Success:
            if not self.bsize:
    ...
    def check_lengths(self,pattern,lengths):
        f = '[MTExtractor] get.Binary.check_lengths'
        if self.Success:
            if lengths:
    ...
    def get_part2(self,pattern,start=0,end=0):
        f = '[MTExtractor] get.Binary.get_part2'
        if self.Success:
    ...
    def get_lengths(self,index_):
        f = '[MTExtractor] get.Binary.get_lengths'
        if self.Success:
    ...
    def close(self):
        f = '[MTExtractor] get.Binary.close'
        if self.Success:
...
class UPage(Binary):
    ...
    def _get_no(self,stem):
        f = '[MTExtractor] get.UPage._get_no'
        try:
    ...
    def _get_ref(self,i):
        f = '[MTExtractor] get.UPage._get_ref'
        if i is None:
            sh.com.rep_empty(f)
        else:
            try:
    ...
    def searchu(self,pattern):
        f = '[MTExtractor] get.UPage.searchu'
        if self.Success:
            self.get_parts()
            if self.part1:
                i = 1
    ...
    def get_parts(self):
        f = '[MTExtractor] get.UPage.get_parts'
        if self.Success:
            if not self.part2:
                if self.get_page():
                    pos = 0
    ...
    def get_page(self):
        f = '[MTExtractor] get.UPage.get_page'
        if self.Success:
            if not self.page:
                if self.get_size():
    ...
    def get_size(self):
        f = '[MTExtractor] get.UPage.get_size'
        if self.Success:
            if not self.psize:
    ...
    def check_parts(self):
        f = '[MTExtractor] get.UPage.check_parts'
        if self.Success:
    ...
    def _get_missing(self):
        ...
        '''
        f = '[MTExtractor] get.UPage._get_missing'
    ...
    def conform_parts(self):
        f = '[MTExtractor] get.UPage.conform_parts'
        if self.Success:
            if self.part1:
                if self.check_parts():
...
class Walker:
    ...
    def get_ending(self):
        f = '[MTExtractor] get.Walker.get_ending'
        if self.Success:
            if not self.ending:
    ...
    def get_subject(self):
        f = '[MTExtractor] get.Walker.get_subject'
        if self.Success:
            if not self.subject:
                fname = 'subjects.txt'
                file  = self.get_file(fname)
    ...
    def get_typein1(self):
        f = '[MTExtractor] get.Walker.get_typein1'
        if self.Success:
            if not self.typein1:
    ...
    def get_typein2(self):
        f = '[MTExtractor] get.Walker.get_typein2'
        if self.Success:
            if not self.typein2:
    ...
    def get_files(self):
        f = '[MTExtractor] get.Walker.get_files'
        if self.Success:
    ...
    def get_article(self):
        f = '[MTExtractor] get.Walker.get_article'
        if self.Success:
            if not self.article:
    ...
    def get_glue1(self):
        f = '[MTExtractor] get.Walker.get_glue1'
        if self.Success:
            if not self.glue1:
    ...
    def get_glue2(self):
        f = '[MTExtractor] get.Walker.get_glue2'
        if self.Success:
            if not self.glue2:
    ...
    def set_langs(self):
        f = '[MTExtractor] get.Walker.set_langs'
        if self.Success:
            lang1       = LANG1.lower()
            lang2       = LANG2.lower()
    ...
    def check(self):
        f = '[MTExtractor] get.Walker.check'
    ...
    def get_stems1(self):
        f = '[MTExtractor] get.Walker.get_stems1'
        if self.Success:
            if not self.stems1:
    ...
    def get_stems2(self):
        f = '[MTExtractor] get.Walker.get_stems2'
        if self.Success:
            if not self.stems2:
    ...
    def get_file(self,fname):
        f = '[MTExtractor] get.Walker.get_file'
        if self.Success:
            try:
...
class TypeIn(UPage):
    ...
    def search(self,pattern):
        f = '[MTExtractor] get.TypeIn.search'
        if self.Success:
            if pattern:
    ...
    def run_reader(self,poses):
        f = '[MTExtractor] get.TypeIn.reader'
        if self.Success:
            if poses:
...
class AllDics:
    ...
    def get_langs(self):
        ...
        files = []
        f = '[MTExtractor] get.AllDics.langs'
        if self.Success:
            #TODO: elaborate
    ...
    def walk(self):
        f = '[MTExtractor] get.AllDics.walk'
        if self.Success:
            pass
        else:
            sh.com.cancel(f)
    ...
    def locate(self):
        f = '[MTExtractor] get.AllDics.locate'
        if self.Success:
            if not self.dics:
                if self.walk():
                    #TODO: implement
    ...
    def load(self):
        f = '[MTExtractor] get.AllDics.load'
        if self.Success:
            pass
        else:
            sh.com.cancel(f)
...
class Commands:
    ...
    def overflowh(self,no):
        ...
        f = '[MTExtractor] get.Commands.overflowh'
        if no < 0:
            result = 32768 + no
            if DEBUG:
    ...
    def overflowb(self,no):
        f = '[MTExtractor] get.Commands.overflowb'
        if no < 0:
    ...
    def unpack(self,chno,mode='<L'):
        f = '[MTExtractor] get.Commands.unpack'
        if chno:
            if mode == '<L':
                chno += b'\x00'
            try:
    ...
    def get_string(self,chunk,limit=200):
        ...
        '''
        f = '[MTExtractor] get.Commands.get_string'
        result = ''
        if chunk:
            try:
    ...
    def get_chunks(self,iterable,limit=3):
        ...
        '''
        f = '[MTExtractor] get.Commands.get_chunks'
        if iterable:
...
class Stems(UPage):
    ...
    def get_speech(self,chno):
        f = '[MTExtractor] get.Stems.get_speech'
        if self.Success:
    ...
    def search(self,stem,end=''):
        # Do not fail the whole class upon a failed search
        f = '[MTExtractor] get.Stems.search'
        if self.Success:
...
class Get:
    ...
    def get_combos(self):
        f = '[MTExtractor] get.Get.get_combos'
        if self.Success:
    ...
    def check(self):
        f = '[MTExtractor] get.Get.check'
        if not self.pattern:
            self.Success = False
            sh.com.rep_empty(f)
    
    def strip(self):
        f = '[MTExtractor] get.Get.strip'
        if self.Success:
    ...
    def get_stems(self):
        f = '[MTExtractor] get.Get.get_stems'
        if self.Success:
